...
> **延伸阅读**：[web-search.md](./web-search.md)（联网引用与 `StreamingMarkdownBody`）、[knowledge/knowledge-assistant-mermaid-streaming.md](../knowledge/knowledge-assistant-mermaid-streaming.md)（Mermaid 流式岛）、[../react/use-stick-to-bottom-scroll.md](../react/use-stick-to-bottom-scroll.md)（贴底滚动）、[../mermaid/markdown-zoom-and-preview.md](../mermaid/markdown-zoom-and-preview.md)（Mermaid 拆岛总览）。
