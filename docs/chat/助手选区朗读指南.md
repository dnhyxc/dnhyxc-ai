...
不展开 `playListenUnitsFromCursor` 内部 for 循环与预取；章节听书差异见 [ideas/EPUB听书核心逻辑.md](../ideas/EPUB听书核心逻辑.md)。
...
- 章节听书主循环、进度条、章节切换（见 [ideas/EPUB听书核心逻辑.md](../ideas/EPUB听书核心逻辑.md)、[ebook/听书互斥控制.md](../ebook/听书互斥控制.md)）
