...
→ **[cos-dev-http-proxy.md](../cos/cos-dev-http-proxy.md)**（主文档）
...
| **Web 生产 HTTPS** | `/ext-cos/` + Nginx 回源（见 [route-auth.md](../auth/route-auth.md) §12） |
...
完整配置片段、capabilities 白名单、换桶 checklist → [cos-dev-http-proxy.md](../cos/cos-dev-http-proxy.md) §5–§8。
...
| 文档 | 内容 |
|------|------|
| [cos-dev-http-proxy.md](../cos/cos-dev-http-proxy.md) | 实现、代码、环境变量、回归 |
| [route-auth.md](../auth/route-auth.md) §12 | mixed content 与调用方 |
