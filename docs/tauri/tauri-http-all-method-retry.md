...
**文档角色**：修复线上桌面端频繁 Toast「网络异常，请检查网络后重试」的 HttpClient 层改动。影响面见 [../impact/app-tauri-http-retry.md](../impact/app-tauri-http-retry.md)。Toast 脱敏与 i18n 见 [http-network-error-toast.md](../app/http-network-error-toast.md)；首轮 GET 重试背景见 [../english/english-learning-list-network-retry.md](../english/english-learning-list-network-retry.md)（其中「仅 GET/HEAD」描述已滞后，以本篇为准）。
...
| 影响面矩阵 | `docs/impact/app-tauri-http-retry.md` |
