...
> **延伸阅读**：[epub-listen-player-bar-ruler-ui.md](./epub-listen-player-bar-ruler-ui.md)（刻度尺 UI）· [epub-listen-bar-loading-controls.md](./epub-listen-bar-loading-controls.md)（loading 时右侧操作）· [epub-listen-rate-after-src.md](./epub-listen-rate-after-src.md)（云端倍速听感）
