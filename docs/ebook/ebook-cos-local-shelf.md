...
> **文档角色**：本轮（2026-06-13）增量实现说明。主链路见 [ebook-reader-shelf.md](./ebook-reader-shelf.md)；连续滚动与 EPUB 设置初版见 [epub-reader-settings-scroll.md](./epub-reader-settings-scroll.md)。
