...
**姊妹文档**：[epub-user-highlight-impl.md](./epub-user-highlight-impl.md)（用户划线全链路主文档）、[epub-thought-underline-impl.md](./epub-thought-underline-impl.md)（想法虚线）。

**延伸阅读**：PopBar「划线 / 删除划线」互斥与覆盖度检测，见本文 §4；全量 PopBar 交互见 [epub-user-highlight-impl.md](./epub-user-highlight-impl.md) §6；**性能、防闪烁、highlightToggle 单槽位**见 [epub-popbar-perf-ux.md](./epub-popbar-perf-ux.md)。
