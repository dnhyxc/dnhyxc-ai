...
**延伸阅读**：[ebook-toc-active-highlight.md](./ebook-toc-active-highlight.md)（目录高亮初版）、[epub-toc-cfi-navigate.md](./epub-toc-cfi-navigate.md)（目录 CFI 跳转）、[epub-listen-bar-playhead-toc.md](./epub-listen-bar-playhead-toc.md)（底栏播放头与目录联动）
...
| 说明 | 路径 |
|------|------|
| 目录高亮初版 | `docs/ebook/ebook-toc-active-highlight.md` |
