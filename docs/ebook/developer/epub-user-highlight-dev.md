...
**延伸阅读**：[epub-highlight-custom-color-picker 影响点分析](../../impact/epub-highlight-custom-color-picker.md) — 自定义色 ColorPicker、`#rrggbb(aa)` 与 PopBar 嵌套取色波及面；[epub-highlight-custom-color.md](../epub-highlight-custom-color.md) — 实现说明与代码对比。
