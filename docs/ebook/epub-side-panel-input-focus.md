...
阅读位保位见姊妹稿 [epub-viewport-pin.md](./epub-viewport-pin.md)（`applyHostResize` 内视口钉住，与交焦解耦）。

**延伸阅读**：[epub-read-split-panel.md](./epub-read-split-panel.md)、[epub-thought-side-panel.md](./epub-thought-side-panel.md)、[ebook-moke-assistant.md](./ebook-moke-assistant.md)、[epub-viewport-pin.md](./epub-viewport-pin.md)、[epub-split-soft-resize.md](./epub-split-soft-resize.md)。
...
- `applyHostResize` **只**做视口钉住 + softResize，**不** focus / inert / reclaim（见 [epub-viewport-pin.md](./epub-viewport-pin.md)）。
...
| 说明 | 路径 |
|------|------|
| 视口钉住 | [epub-viewport-pin.md](./epub-viewport-pin.md) |
| 分栏布局 | [epub-read-split-panel.md](./epub-read-split-panel.md) |
| 想法 UI | [epub-thought-side-panel.md](./epub-thought-side-panel.md) |
| MOKE 助手（旧 focusInputAtEndKey 叙述需以本文为准） | [ebook-moke-assistant.md](./ebook-moke-assistant.md) |
| softResize | [epub-split-soft-resize.md](./epub-split-soft-resize.md) |
