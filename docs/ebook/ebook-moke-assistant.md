...
**详见** `epub-assistant-context-menu.md`。本轮与之衔接点：
...
**完整专题**：`../knowledge/assistant-insert-focus.md`。
...
- **旧 EPUB 助手文档**（`epub-assistant-context-menu.md`）中「顶栏无助手按钮」已过时；以本文 + 源码为准（顶栏 Bot 已加）。  
...
| 知识库聚焦专题 | `docs/knowledge/assistant-insert-focus.md` |
