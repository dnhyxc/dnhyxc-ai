...
- [ideas/epub-public-thought-underline-overlay-fix.md](../ideas/epub-public-thought-underline-overlay-fix.md) — 规划态排查时间线与架构图
- [epub-thought-partial-overlap.md](./epub-thought-partial-overlap.md) — 私有书单用户部分重叠去重（旧 `thoughtBlockers` 链）
- [epub-thought-user-highlight-overlap.md](./epub-thought-user-highlight-overlap.md) — 想法虚线与用户划线叠加
- [developer/epub-mark-layers-shared.md](./developer/epub-mark-layers-shared.md) — sync 编排总览
