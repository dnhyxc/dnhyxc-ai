...
**延伸阅读**：[epub-quote-listen.md](./epub-quote-listen.md)（旧独立听当前会话）、[epub-chapter-listen.md](./epub-chapter-listen.md)（听书主链路）、[epub-listen-popbar-dismiss.md](./epub-listen-popbar-dismiss.md)（PopBar 入口 UX）、[developer/epub-listen-dev.md](./developer/epub-listen-dev.md)
