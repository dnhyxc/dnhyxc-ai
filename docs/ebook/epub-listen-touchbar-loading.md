...
> **延伸阅读**：[epub-listen-soft-pause.md](./epub-listen-soft-pause.md)（软暂停与媒体键基线）、[epub-listen-play-loading.md](./epub-listen-play-loading.md)（播放钮 loading）、[epub-listen-loading-while-await.md](./epub-listen-loading-while-await.md)（连播持续 loading）、[../chat/selection-speak-media-session.md](../chat/selection-speak-media-session.md)（选区朗读接入 Media Session）。
...
| 软暂停基线 | 不替代 [epub-listen-soft-pause.md](./epub-listen-soft-pause.md)；本专题只收窄 loading 窗口 |
...
| 软暂停基线专题 | `docs/ebook/epub-listen-soft-pause.md` |
| loading UI 专题 | `docs/ebook/epub-listen-play-loading.md` |
| 连播持续 loading | `docs/ebook/epub-listen-loading-while-await.md` |
