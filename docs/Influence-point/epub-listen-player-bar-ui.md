...
**对照的既有能力**（来自 `docs/ebook/epub-listen-player-bar.md`、`useEpubChapterListen` / `useEbookQuoteListen`、`read.tsx`）：
...
| 文档 | 说明 |
|------|------|
| `docs/ebook/epub-listen-player-bar.md` | 仍描述 2 列倍速网格与 `CHAPTER_LISTEN_RATES`；未写虚拟列表与刻度尺 |
