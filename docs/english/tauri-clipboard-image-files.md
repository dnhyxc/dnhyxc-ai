...
> 延伸阅读：
> - [docs/english/tauri-clipboard-tiptap.md](./tauri-clipboard-tiptap.md) —— 早期「纯文本 / HTML flavor」剪贴板接管方案（基线）。
> - [docs/ideas/tauri-clipboard-rich-paste.md](../ideas/tauri-clipboard-rich-paste.md) —— 完整图文混合粘贴方案思路与四级降级设计。
