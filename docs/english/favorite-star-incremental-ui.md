...
> 重试失败后 Toast 脱敏与 i18n 见 [`http-network-error-toast.md`](../app/http-network-error-toast.md)；单词 500 上限与增量 Hook 初版见 [`vocab-favorite-status-query.md`](./vocab-favorite-status-query.md)。
