...
| 同域既有专题：流式代码块滚动 | `docs/chat/streaming-code-block-scroll.md` |
| 同域既有专题：助手流式结束贴底 | `docs/knowledge/assistant-stream-end-scroll-pin.md` |
| 同域既有专题：知识库预览滚动卡顿 | `docs/knowledge/knowledge-preview-scroll-jank.md` |
