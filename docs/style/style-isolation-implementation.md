...
>
> Realm 键粒度、Portal 收编、HMR 重包与 sonner 保护详见 [style-isolation-realm-portal.md](../style/style-isolation-realm-portal.md)。
>
> **第三轮加固**（qiankun 式 transpile / CSSOM / 跨框架 body Portal / `captureStack`）详见 [style-isolation-qiankun-harden.md](../style/style-isolation-qiankun-harden.md)；勿把本文代码块当作现行全文。
