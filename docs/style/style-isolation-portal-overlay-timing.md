...
>
> **延伸阅读**：[style-isolation-tech-overview.md(../style/style-isolation-tech-overview.md)（技术总览）· [style-isolation-implementation.md](../style/style-isolation-implementation.md)（首轮实现手册）· [style-isolation-realm-portal.md](../style/style-isolation-realm-portal.md)（第二轮 Realm + Portal）· [style-isolation-qiankun-harden.md](../style/style-isolation-qiankun-harden.md)（第三轮 qiankun 级加固）· [plugin-vue-bridge.md](../plugins/plugin-vue-bridge.md)（Vue 子应用桥接）
