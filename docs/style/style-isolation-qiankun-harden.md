...
>
> **延伸阅读**：[style-isolation-realm-portal.md](../style/style-isolation-realm-portal.md) · [style-isolation-dev-exclude-host.md](./style-isolation-dev-exclude-host.md) · [style-isolation-implementation.md](../style/style-isolation-implementation.md) · [style-isolation-tech-overview.md(../style/style-isolation-tech-overview.md) · 插件详解 [`mf-implementation-guide.md` §2.10.2](../../apps/frontend/src/plugins/docs/mf-implementation-guide.md)
...
| 文档 | 说明 |
| --- | --- |
| [style-isolation-realm-portal.md](../style/style-isolation-realm-portal.md) | 第二轮：realm 键 + React Portal + HMR |
| [style-isolation-implementation.md](../style/style-isolation-implementation.md) | 首轮 CSS `@scope` 实现 |
| [style-isolation-dev-exclude-host.md](./style-isolation-dev-exclude-host.md) | dev 模式排除 Host 样式 |
| [style-isolation-tech-overview.md(../style/style-isolation-tech-overview.md) | 整体技术说明 |
| [`mf-implementation-guide.md` §2.10.2](../../apps/frontend/src/plugins/docs/mf-implementation-guide.md) | 插件详解中的样式隔离章节 |
