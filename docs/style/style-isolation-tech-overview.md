...
>
> **延伸阅读**：[style-isolation-qiankun-harden.md](../style/style-isolation-qiankun-harden.md)（第三轮：transpile / CSSOM / 跨框架 Portal）· [style-isolation-realm-portal.md](../style/style-isolation-realm-portal.md) · [style-isolation-implementation.md](../style/style-isolation-implementation.md)
...
| qiankun experimentalStyleIsolation / next `@scope` transpile | 低 | 较好 | 中～高 | ✅ 支持 | ✅ 意图对齐：原生 `@scope` + hoist/keyframes/CSSOM（见 [qiankun-harden](../style/style-isolation-qiankun-harden.md)） |
...
| 文档 | 内容 | 适合谁看 |
|------|------|---------|
| [style-isolation-implementation.md](../style/style-isolation-implementation.md) | 完整实现手册（逐行代码注释、工作流程、边界情况） | 需要深入理解实现的开发者 |
| [host-plugin-integration-guide.md](../plugins/host-plugin-integration-guide.md) | 主项目接入插件方式指南 | 主项目业务开发者 |
| [plugin-development-guide.md](../plugins/plugin-development-guide.md) | 子项目/插件开发手册 | 插件开发者 |
| [mf-implementation-guide.md](../plugins/mf-implementation-guide.md) | MF 实现过程总文档 | 架构师 / 核心开发者 |
