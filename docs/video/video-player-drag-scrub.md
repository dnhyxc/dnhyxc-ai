...
>
> **延伸阅读**：[video-player-plugin.md](../video/video-player-plugin.md)（插件化接入 / 影院态全屏）· [video-player-component-refactor.md](../video/video-player-component-refactor.md)（组件化拆分）· [video-player-feature-enhancement.md](./video-player-feature-enhancement.md)（缩略图预览 / PiP / locale 跟随）
...
| 播放器组件总览文档 | [video-player-component-refactor.md](../video/video-player-component-refactor.md) |
