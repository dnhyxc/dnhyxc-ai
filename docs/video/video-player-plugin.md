...
> **文档角色**：记录视频播放器 MF 插件的**插件化接入**（宿主 → 插件桥接、影院态全屏、路由挂载、独立预览）。播放器**组件化拆分 / 通用化**的设计与代码改动见 [video-player-component-refactor.md](../video/video-player-component-refactor.md)。
>
> **延伸阅读**：[video-player-component-refactor.md](../video/video-player-component-refactor.md) · [plugin-cinema-fullscreen.md](../plugins/plugin-cinema-fullscreen.md)
