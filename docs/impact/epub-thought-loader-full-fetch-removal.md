...
- [epub-thought-viewport-mark.md](./epub-thought-viewport-mark.md) — 按章 `spineHints` + 视口 mark 总体波及面
- [epub-thought-viewport-perf.md](../ebook/epub-thought-viewport-perf.md) — `useEbookThoughtLoader` 实现说明
- [epub-public-thought-live-sync.md](./epub-public-thought-live-sync.md) — 公开书 `/sync` 增量（与 list 全量无关）
...
| 文档 | 说明 |
|------|------|
| [epub-thought-viewport-mark.md](./epub-thought-viewport-mark.md) §1 | 「PDF 想法 \| loader 仍全书一次 fetch」已过时；PDF 不支持想法且无 list |
| [epub-thought-viewport-perf.md](../ebook/epub-thought-viewport-perf.md) §3.2 | 仍写「PDF：仍全书一次」；应以本篇为准 |
