...
- [selection-speak-context-menu.md](../english/selection-speak-context-menu.md) — 实现与改动前后对比
- [epub-listen-cadence-lead.md](./epub-listen-cadence-lead.md) — 切句提前对选区朗读预览的影响（动机方）
- [epub-context-menu-popbar.md](../ebook/epub-context-menu-popbar.md) — EPUB 选区菜单底座
...
| 听书/听当前 TTS 链路 | **否** | `playListenPlainText` 复用既有 `playListenUnitsFromCursor`，未改其内部逻辑；切句时序变化见 [epub-listen-cadence-lead.md](./epub-listen-cadence-lead.md) |
...
无。实现专题 [selection-speak-context-menu.md](../english/selection-speak-context-menu.md) 与本篇同轮产出。
