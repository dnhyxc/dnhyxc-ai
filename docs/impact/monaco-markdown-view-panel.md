...
- [markdown-view-panel-scroll.md](../monaco/markdown-view-panel-scroll.md) — 实现思路与改动前后代码对比
...
| 文档 | 说明 |
|------|------|
| `docs/project-update-info.md` / `docs/project-guide.md` | 同轮已增 §7 / §12 条目，与改后产品语义一致 |
| `docs/monaco/markdown-view-panel-scroll.md` | 同轮新增实现专题，可作为开发侧对照 |
| `docs/monaco/markdown-bottom-bar.md` | 若文中仍写「切换 preview/edit 会关助手」，需改为「仅 split/Diff 等路径关助手」 |
