...
| [知识预览助手性能.md](./知识预览助手性能.md) | **预览+助手同开**：SSE rAF 合并、消息列隔离、busy latch、预览加载态 |
| [知识预览滚动卡顿.md](./知识预览滚动卡顿.md) | **长预览滚动卡顿**：FAB 去重、岛屿 HTML memo、toolbar enabled、流式贴底 rAF 合并；步骤手册见 [../ideas/知识库滚动卡顿修复.md](../ideas/知识库滚动卡顿修复.md) |
