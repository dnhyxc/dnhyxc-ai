...
> **延伸阅读**：[知识编辑器长文本性能.md](./知识编辑器长文本性能.md)（M1 长文 edit 隔离）、[知识预览滚动卡顿.md](./知识预览滚动卡顿.md)（预览滚动 FAB/memo/toolbar/贴底 rAF）、[../ideas/知识预览助手性能.md](../ideas/知识预览助手性能.md)（规划态思路）、[../impact/知识库预览助手面板性能影响.md](../impact/知识库预览助手面板性能影响.md)（影响面与回归清单）、[知识库助手完成.md](./知识库助手完成.md)（助手总览）。
