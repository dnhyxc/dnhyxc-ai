...
- **实现归档（主文档）**：[epub-thought-viewport-perf.md](../ebook/epub-thought-viewport-perf.md)
- [ebook-public-thought-live-sync.md](./ebook-public-thought-live-sync.md) — `/sync` 双轨触发、聚类列表、接口总览
- [ebook-thought-sync-perf-optimization.md](./ebook-thought-sync-perf-optimization.md) — SQL 增量、deletedIds、私有书 gate
- [epub-scroll-stutter-perf.md](./epub-scroll-stutter-perf.md) — relocated 80ms 合并、叠层投影缓存
- [epub-public-thought-underline-overlay-fix.md](./epub-public-thought-underline-overlay-fix.md) — 多人虚线叠层与 patch 几何
- [epub-mark-layers.md](./epub-mark-layers.md) — 用户线 / 想法线 / 听书背景三层
