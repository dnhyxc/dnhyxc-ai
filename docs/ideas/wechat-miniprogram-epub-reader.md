...
- [epub-all-features-dev.md](../ebook/developer/epub-all-features-dev.md) — Web 端 EPUB 全功能开发者手册（实现思路主要参考）
- [epub-listen-dev.md](../ebook/developer/epub-listen-dev.md) — 听书功能开发者手册
- [epub-thought-add-underline-dev.md](../ebook/developer/epub-thought-add-underline-dev.md) — 读书想法开发者手册
- [epub-user-highlight-dev.md](../ebook/developer/epub-user-highlight-dev.md) — 用户划线开发者手册
- [ebook-shelf-sort-last-read.md](../ebook/ebook-shelf-sort-last-read.md) — 书架最近阅读排序实现
- [ebook-progress-remote-debounce.md](../ebook/ebook-progress-remote-debounce.md) — 阅读进度去抖保存
