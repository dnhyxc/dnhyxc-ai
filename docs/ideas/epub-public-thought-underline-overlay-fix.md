...
> **关联需求**：[ebook-share.md](../../apps/frontend/specs/ebook-share.md) §5.3 叠层与命中

## 延伸阅读

- [epub-public-thought-underline-overlay.md](../ebook/epub-public-thought-underline-overlay.md) — **实现归档**：改动前后代码对比与逐段注释
- [epub-mark-layers.md](./epub-mark-layers.md) — 用户线 / 想法线 / 播放层三层编排总览
- [epub-mark-epubjs-primitives.md](./epub-mark-epubjs-primitives.md) — CFI、annotations.underline、marks-pane 原语
- [ebook-share.md](../../apps/frontend/specs/ebook-share.md) — 公开书 MVP 与 `#d97706` / `#797673` 色规范
