...
- [impact/epub-listen-bg-vs-annotations.md](../impact/epub-listen-bg-vs-annotations.md) — 播放层 vs 划线层影响面
...
| 文档（实现后） | `docs/ebook/epub-user-highlight-impl.md`、`epub-thought-underline-impl.md`、`epub-listen-*.md` |

---

（本文档为规划态实现思路；落地细节以 [epub-mark-layers-shared.md](../ebook/developer/epub-mark-layers-shared.md) 与源码为准）
