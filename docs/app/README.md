...
| [plugin-vue-bridge.md](./plugin-vue-bridge.md) | **Vue 子应用桥接（跨框架插件支持）**：`createVueHostBridge` + `normalizePluginModule`、registry `framework` 字段、Vue shared 单例、i18n 帮助文本（含改动前/后对比与逐行注释） |
