...
- [auth-wechat-mini-program-bind.md](../Influence-point/auth-wechat-mini-program-bind.md) — 影响点分析与回归清单
- [wechat-quick-login.md](../../apps/backend/specs/wechat-quick-login.md) — 后端 SPEC 设计基线
- [user-switch-state-reset.md](./user-switch-state-reset.md) — 用户切换与 token 失效机制
- [route-auth.md](./route-auth.md) — 前端路由鉴权
