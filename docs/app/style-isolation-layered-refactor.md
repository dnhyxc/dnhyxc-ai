...
>
> 历史实现与细节：
> - 初始 `@scope` 方案见 [style-isolation-implementation.md](./style-isolation-implementation.md)；
> - qiankun 级加固与 `transpileStyleText` / CSSOM 见 [style-isolation-qiankun-harden.md](./style-isolation-qiankun-harden.md)；
> - Realm 键粒度、Portal 收编、HMR 重包见 [style-isolation-realm-portal.md](./style-isolation-realm-portal.md)；
