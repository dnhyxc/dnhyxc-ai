...
- [dynamic-plugin-system.md](./dynamic-plugin-system.md) — 动态插件系统核心实现（Vite MF、PluginManager 生命周期、路由/侧栏注入）
- [mf-implementation-guide.md](./mf-implementation-guide.md) — Module Federation 实现过程总文档
- [host-plugin-integration-guide.md](./host-plugin-integration-guide.md) — 主项目接入插件方式
- [plugin-development-guide.md](./plugin-development-guide.md) — 子项目/插件开发手册
