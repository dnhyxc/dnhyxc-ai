...
**延伸阅读**：
- [mf-implementation-guide.md](./mf-implementation-guide.md)：完整的 MF 实现过程文档（含子项目实现）
- [plugin-development-guide.md](./plugin-development-guide.md)：面向插件开发者的开发手册
- [host-plugin-integration-guide.md](./host-plugin-integration-guide.md)：主项目接入插件的详细说明与示例
