...
> **延伸阅读**：[plugin-shelf-toggle.md](./plugin-shelf-toggle.md)；[plugin-registry-i18n.md](./plugin-registry-i18n.md)；[plugin-entry-cache-bust.md](./plugin-entry-cache-bust.md)。
