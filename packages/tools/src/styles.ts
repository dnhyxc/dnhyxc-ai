// 此文件由 scripts/build-css.js 自动生成
// 请勿手动修改

export const githubMarkdownCss = `.markdown-body {
  --base-size-4: 0.25rem;
  --base-size-8: 0.5rem;
  --base-size-16: 1rem;
  --base-size-24: 1.5rem;
