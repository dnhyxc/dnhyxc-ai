	...
	return (function (t) {
		...
		function (t, e, i) {
			...
			var f = class {
				...
				overrides(t) {
					...
					for (var i in e)
						Object.hasOwn(e, i) && t.css(i, e[i].value, e[i].priority);
				}
				fontSize(t) {
			...
			const h = Math.PI / 2,
				l = {
					...
					easeInOutQuint: function (t) {
						return (t /= 0.5) < 1 ? 0.5 * t ** 5 : 0.5 * ((t - 2) ** 5 + 2);
					},
		...
		function (t, e, i) {
			...
			function c(t, e, i, s, r, o) {
				function a(t, e, n) {
					Object.hasOwn(i.attributeNames, t) &&
