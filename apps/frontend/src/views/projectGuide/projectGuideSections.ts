...
const PROJECT_GUIDE_SECTIONS_ZH: ProjectGuideSection[] = [
	{
		...
		items: [
			...
			},
			{
				...
				title: '英语学习',
				description:
					'按主题生成单词包与经典句，支持收藏、抽屉管理与导出 Word（DOCX）等（需登录后使用主能力）。',
			},
			{
				id: 'pg-s1-3',
				title: 'Markdown 增强',
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				description:
					'单词或经典句可收藏；收藏列表在抽屉中分页浏览与管理。可将单词收藏或经典句收藏分别一键导出为 DOCX；服务端按账号汇总至多约 3000 条（按收藏时间倒序），与抽屉当前页无关。浏览器与桌面客户端均走二进制下载与本地保存；桌面端若有同名去重或提示以实现为准。',
			},
		],
	},
	{
