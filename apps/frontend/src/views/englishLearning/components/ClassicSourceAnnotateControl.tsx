...
type ClassicSourceAnnotateControlProps = {
	source: 'library' | 'pack';
	libraryId?: string;
	streamId?: string;
	/** 任务标题（库名 / Pack 主题） */
...
function ClassicSourceAnnotateControlInner({
	source,
	libraryId,
	streamId,
	title,
	...
	className,
	onBeforeClick,
}: ClassicSourceAnnotateControlProps) {
	const { t } = useI18n();
...
export const ClassicSourceAnnotateControl = observer(
	ClassicSourceAnnotateControlInner,
);
