 ...
 * 结算板配色 — 低透明度渐变底
 */
export type MetricTone = 'accent' | 'correct' | 'wrong' | 'total' | 'practiced';
...
export const METRIC_TONE: Record<MetricTone, MetricToneStyle> = {
	accent: {
...
export const ACCENT_TONE = METRIC_TONE.accent;
