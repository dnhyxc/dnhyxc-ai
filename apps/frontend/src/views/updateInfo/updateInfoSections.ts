	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				dateLabel: '2026-06-08',
				description:
					'在同一浏览器内登出、换号登录或会话 401 失效时，会自动清空与上一账号相关的前端展示缓存，包括知识库未保存草稿、文档助手与 RAG 对话、英语学习 Agent 聊天与进行中的单词包/经典句进度等，避免误看到他人内容。同一账号仅更新资料或会员状态（用户 id 不变）时不会清空。',
			},
			{
				id: 's2-7',
				title: '个人主页会员标识优化',
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				dateLabel: '2026-06-09',
				description:
					'与大模型配置分开；可开关自定义朗读参数（模型、英文音色、语速/音量/音高、情感、音频格式、语言增强及高级采样项），修改即时保存在本机，支持试听与恢复默认；未开启时仍按服务端默认合成。',
			},
		],
	},
];
