	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				dateLabel: '2026-06-08',
				description:
					'自定义朗读参数由浏览器本地存储改为账号级云端保存；同一账号在不同电脑或浏览器登录后设置一致。系统设置中的本机朗读音色仍仅保存在当前设备。',
			},
			{
				id: 's24-35',
				title: '云端朗读设置仅会员可见',
				dateLabel: '2026-06-08',
				description:
					'有效会员才在设置菜单中看到「云端朗读」；非会员入口隐藏，直接打开对应设置页会回到设置首页。非会员在英语学习中仍可使用本机朗读（系统设置中的本机音色）。',
			},
			{
				id: 's24-36',
				title: '本机朗读音色按账号隔离',
				dateLabel: '2026-06-08',
				description:
					'系统设置中的本机英语音色偏好在同一浏览器内按登录账号分别保存；换号后设置页下拉框与朗读会使用对应账号的配置，互不覆盖（仍仅存于当前设备，不跨设备同步）。',
			},
		],
	},
];
