export const zhCN = {
	...
	'englishLearning.practice.classicDictationHint': '听读音，在下方输入整句英文',
	...
	'englishLearning.practice.shortcuts.footnote':
		'首次答错与看答案后：焦点在输入框内时不响应方向键；↑ 上一题仅非首题可用。作答中 Shift + 空格 可随时播放/停止。',
	...
	'englishLearning.practice.progress': '第 {current} / {total} 题',
	'englishLearning.practice.exit': '结束练习',
	'englishLearning.practice.dictationHint': '听读音，在下方输入英文拼写',
	...
	'englishLearning.mistakes.selectedCount': '已选 {count} 项',
	'englishLearning.mistakes.removeSelected': '移除所选',
