export const zhCN = {
	...
	'route.ebook.title': '书架',
	'route.ebook.read': '阅读',

	'ebook.shelf.title': '电子书书架',
	'ebook.shelf.hint':
		'支持 EPUB、PDF；桌面端可直接打开本地文件，网页端请导入文件。',
	'ebook.shelf.hintTauri': '支持 epub、pdf，点击选择本地文件',
	'ebook.shelf.hintWeb': '支持 epub、pdf，点击导入文件',
