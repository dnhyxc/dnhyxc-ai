...
const Sidebar = () => {
	...
	return (
		<div
			...
			className="w-20 h-full flex flex-col items-center pt-7 px-2"
		>
			<div
				data-tauri-drag-region
				className="flex justify-center items-center w-12 h-12 bg-border cursor-pointer mb-8 rounded-md hover:shadow-(--shadow-10) hover:text-green-600 transition-all duration-200 ease-in-out"
				onClick={() => onJump('/')}
			>
